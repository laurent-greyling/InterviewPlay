...
namespace InterviewPlay.Services
{
    public class SurveyDbContext: DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server=tcp:surveyplay.database.windows.net,1433;Initial Catalog=SurveyDetails;Persist Security Info=False;User ID=laurent;Password=karen@K1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
    }
}
